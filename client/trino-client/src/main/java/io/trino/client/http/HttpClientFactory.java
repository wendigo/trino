...
import static io.trino.client.http.HttpClientUtils.basicAuth;
import static io.trino.client.http.HttpClientUtils.setupAlternateHostnameVerification;
import static io.trino.client.http.HttpClientUtils.setupCookieJar;
import static io.trino.client.http.HttpClientUtils.setupHttpLogging;
import static io.trino.client.http.HttpClientUtils.setupHttpProxy;
import static io.trino.client.http.HttpClientUtils.setupInsecureSsl;
import static io.trino.client.http.HttpClientUtils.setupKerberos;
import static io.trino.client.http.HttpClientUtils.setupSocksProxy;
import static io.trino.client.http.HttpClientUtils.setupSsl;
import static io.trino.client.http.HttpClientUtils.setupTimeouts;
import static io.trino.client.http.HttpClientUtils.tokenAuth;
import static io.trino.client.http.HttpClientUtils.userAgent;
