...
1. Start the Full Development Server as documented
   [here](https://github.com/trinodb/trino?tab=readme-ov-file#running-the-full-server).
   This step is only necessary once, and you won't need to restart it while
   developing the Preview Web UI. It is required solely to proxy API requests to
   valid server endpoints.
