...
public class QueryDataEncodingConfig
{
    ...
    private boolean arrowIpcEnabled = true;
    private boolean arrowIpcZstdEnabled = true;
    private boolean arrowIpcLz4Enabled = true;
    ...
    @Config("protocol.spooling.encoding.arrow-ipc.enabled")
    ...
    @Config("protocol.spooling.encoding.arrow-ipc+zstd.enabled")
    ...
    public boolean isArrowIpcLz4Enabled()
    {
        return arrowIpcLz4Enabled;
    }

    @Config("protocol.spooling.encoding.arrow-ipc+lz4.enabled")
    @ConfigDescription("Enable LZ4 compressed Arrow spooled encoding")
    public QueryDataEncodingConfig setArrowIpcLz4Enabled(boolean arrowIpcLz4Enabled)
    {
        this.arrowIpcLz4Enabled = arrowIpcLz4Enabled;
        return this;
    }
