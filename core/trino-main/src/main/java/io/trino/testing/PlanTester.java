        ...
        implements Closeable
{
    ...
    private PlanTester(Session defaultSession, int nodeCountForStats)
    {
        ...
        spoolingManagerRegistry = new SpoolingManagerRegistry(new InMemoryNodeManager(), new SpoolingEnabledConfig(), noop(), noopTracer());
    ...
    public Plan createPlan(Session session, @Language("SQL") String sql, List<PlanOptimizer> optimizers, LogicalPlanner.Stage stage, WarningCollector warningCollector, PlanOptimizersStatsCollector planOptimizersStatsCollector)
    {
        ...
        LogicalPlanner logicalPlanner = new LogicalPlanner(
                ...
                idAllocator,
                getPlannerContext(),
                new SpoolingManagerRegistry(new InMemoryNodeManager(), new SpoolingEnabledConfig(), noop(), noopTracer()),
                statsCalculator,
                costCalculator,
                warningCollector,
                planOptimizersStatsCollector,
