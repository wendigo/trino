        ...
        extends AbstractTestQueryFramework
{
    ...
    private Multiset<FileOperation> getOperations(List<SpanData> spanData)
    {
        return spanData.stream()
                .filter(TestDeltaLakeFileOperations::isFileSystemSpan)
                .filter(span -> {
                ...
                .map(span -> FileOperation.create(requireNonNull(span.getAttributes().get(FILE_LOCATION), "FILE_LOCATION attribute is empty"), span.getName()))
                .collect(toCollection(HashMultiset::create));
    }

    private static boolean isFileSystemSpan(SpanData spanData)
    {
