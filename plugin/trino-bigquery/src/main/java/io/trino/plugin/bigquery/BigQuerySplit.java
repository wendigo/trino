        ...
        implements ConnectorSplit
{
    ...
    public BigQuerySplit(
            ...
            @JsonProperty("arrowSchema") String arrowSchema,
            ...
            @JsonProperty("dataSize") OptionalInt dataSize)
    {
        ...
        this.arrowSchema = requireNonNull(arrowSchema, "arrowSchema cannot be null");
    ...
    static BigQuerySplit forStream(String streamName, String arrowSchema, List<ColumnHandle> columns, OptionalInt dataSize)
    {
        return new BigQuerySplit(STORAGE, streamName, arrowSchema, columns, NO_ROWS_TO_GENERATE, Optional.empty(), dataSize);
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(mode, that.mode) &&
                ...
                Objects.equals(arrowSchema, that.arrowSchema) &&
    ...
    public int hashCode()
    {
        return Objects.hash(mode, streamName, arrowSchema, columns, emptyRowsToGenerate);
    }
