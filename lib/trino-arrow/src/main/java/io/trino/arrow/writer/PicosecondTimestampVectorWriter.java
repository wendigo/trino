...
public final class PicosecondTimestampVectorWriter
        implements ArrowVectorWriter
{
    private final Timestamp12Vector vector;

    public PicosecondTimestampVectorWriter(Timestamp12Vector vector)
    {
        this.vector = vector;
    }
