...
public class Timestamp0ColumnWriter
        extends FixedWidthColumnWriter<TimeStampSecVector>
{
    private final TimestampType type;

    public Timestamp0ColumnWriter(TimeStampSecVector vector, TimestampType type)
    {
        super(vector);
