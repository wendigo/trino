...
public class Timestamp9ColumnWriter
        extends FixedWidthColumnWriter<TimeStampNanoVector>
{
    private final TimestampType type;

    public Timestamp9ColumnWriter(TimeStampNanoVector vector, TimestampType type)
    {
        super(vector);
        this.type = type;
    }
