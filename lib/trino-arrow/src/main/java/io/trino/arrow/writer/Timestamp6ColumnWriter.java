...
public class Timestamp6ColumnWriter
        extends FixedWidthColumnWriter<TimeStampMicroVector>
{
    private final TimestampType type;

    public Timestamp6ColumnWriter(TimeStampMicroVector vector, TimestampType type)
    {
        super(vector);
        this.type = type;
    }
