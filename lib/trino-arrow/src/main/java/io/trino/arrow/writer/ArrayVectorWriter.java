...
public final class ArrayVectorWriter
        implements ArrowVectorWriter
{
    private final ListVector vector;
    private final ArrayType type;

    public ArrayVectorWriter(ListVector vector, ArrayType type)
    {
    ...
    public void write(Block block)
    {
        ...
        if (block instanceof ArrayBlock arrayBlock) {
            ...
            ArrowVectorWriter elementWriter = createArrowWriter(vector.getDataVector(), type.getElementType());
