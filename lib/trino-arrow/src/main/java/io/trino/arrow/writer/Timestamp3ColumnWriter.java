...
public class Timestamp3ColumnWriter
        extends FixedWidthColumnWriter<TimeStampMilliVector>
{
    private final TimestampType type;

    public Timestamp3ColumnWriter(TimeStampMilliVector vector, TimestampType type)
    {
        super(vector);
        this.type = type;
    }
