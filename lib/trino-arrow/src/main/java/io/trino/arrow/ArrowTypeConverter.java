...
import io.trino.arrow.extension.Time12Type;
import io.trino.arrow.extension.TimeWithValueTimezoneType;
import io.trino.arrow.extension.Timestamp12Type;
    ...
    private static ArrowType toArrowType(Type type)
    {
        return switch (type) {
            ...
            case TimestampType timestamp -> switch (timestamp.getPrecision()) {
                ...
                case 12 -> new Timestamp12Type(null);
            ...
            case DecimalType decimal -> decimal.isShort() ? new ArrowType.Decimal(decimal.getPrecision(), decimal.getScale(), 64) : new ArrowType.Decimal(decimal.getPrecision(), decimal.getScale(), 128);
